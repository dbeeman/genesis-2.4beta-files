...
/* Note some hacks below:
   ...
   The tables for the Na, Kdr, Ca channels have an expanded range
   from -0.125 to 0.075 V to allow shifting
...
/* This one has to be names Ca_conc, however */
